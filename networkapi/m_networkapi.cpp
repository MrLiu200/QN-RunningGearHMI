            ...
            while (!in.atEnd()) {
                ...
                if(line == "BearingInfo"|| line == "PreInfo"){
                    ...
                    if(infotype == "BearingInfo"){
                        ...
                        device.shaftDiameter = dataList.at(6).trimmed().toFloat();
                        device.bearing1_name = dataList.at(7).trimmed();
                        device.bearing1_model = dataList.at(8).trimmed();
                        device.bearing2_name = dataList.at(9).trimmed();
                        device.bearing2_model = dataList.at(10).trimmed();
                        device.bearing3_name = dataList.at(11).trimmed();
                        device.bearing3_model = dataList.at(12).trimmed();
                        device.bearing4_name = dataList.at(13).trimmed();
                        device.bearing4_model = dataList.at(14).trimmed();
                        device.capstanname = dataList.at(15).trimmed();
                        device.capstanTeethNum = dataList.at(16).trimmed().toInt();
                        device.drivenwheelName = dataList.at(17).trimmed();
                        device.drivenwheelTeethNum = dataList.at(18).trimmed().toInt();
                        device.version = dataList.at(19).trimmed();
                        device.IsEnable = dataList.at(20).trimmed().toInt();
